...
from domain import FAMILIAS_PROJETORES, HORARIOS, HORARIOS_POR_INICIO
from domain import LIMITE_COMPUTADORES_POR_RESERVA, LOCAL_LABORATORIO
from domain import NIVEL_LABELS, ORDEM_TIPO_TAREFA, RECURSOS_COMPUTADORES
from domain import SALAS, TIPOS_USUARIO, TOTAL_PROJETORES, hora_para_minutos
